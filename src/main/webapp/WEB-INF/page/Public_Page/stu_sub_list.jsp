...
<style>
	...
	<div class="row" style="margin-top: 50px;">
		<div class="col-xs-12 col-md-11 col-md-offset-1">
			<form action="<%=basePath%>secretary/findStuSubmit_findStuBySubStatus.shtm"
				id="select" method="post">
				<input type="hidden" value="${stageName}" name="stageName">
				<input type="hidden" value="${leaderStatus}" name="leaderStatus">
				<input type="hidden" value="${major}" name="major"> <input
					type="hidden" value="${className}" name="className"> 
			...
			<form role="form" action="<%=basePath%>secretary/exportStuBySubStatus.shtm"
				method="post">
