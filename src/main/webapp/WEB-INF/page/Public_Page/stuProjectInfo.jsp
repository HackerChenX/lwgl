			...
			<div class="row">
				<div class="col-md-9 col-md-offset-1">
					<div class="panel panel-primary">
						...
						<form class="form-horizontal" role="form" method="post" action="<%=basePath %>secretary/findApplyTitle_checkStuTitile.shtm">
							...
							<div class="alert alert-info" style="margin-top: 20px">
								<p>通过：表示教学秘书认可该课题，学生可用此题目作为论文题目。</p>
                                <p>退回修改：表示教学秘书不认可该课题，要求学生根据审核意见修改课题内容，重新申报。</p>
							</div>			
							</div>
						</form>				
					</div>
