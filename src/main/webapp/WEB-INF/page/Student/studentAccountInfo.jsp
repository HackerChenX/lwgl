				...
				<div class="col-md-9 col-md-offset-1">
					<div class="panel panel-primary">
						...
						<div class="panel-body" style="padding-bottom: 100px;padding-top: 50px;">
							<form class="form-horizontal" role="form" method="post" action="<%=basePath %>student/findInfo_updateStuInfo.shtm" onsubmit="return $.check()">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input class="form-control" type="text" name="stuName" value="${student.stuName }" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<input class="form-control input-sm" type="text" name="sex" id="sel" readonly="readonly"/>										
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<input class="form-control input-sm" type="text" name="major" id="major" onchange="changeMajor()" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<input class="form-control input-sm" type="text" name="stuClass" id="class" readonly="readonly"/>
									</div>
								</div>
	...
	<script type="text/javascript">
		jQuery.extend({ 
				check:function(){
					...
					var major = $("select[name='major']").val();stuClass
