	...
	<body>
		<div class="row">
			...
			<div class="col-md-4" style="margin-top: 100px;">
				...
				<input hidden="hidden" value="finalPaper" name="stage"/>
				<input hidden="hidden" value="${filePathSrc}" name="filePathSrc" id="filePathSrc"/>
					<div class="panel panel-primary">
						<div class="panel-heading"><span class="fa fa-pencil-square-o ">&nbsp;&nbsp;审阅意见表</span></div>
						<div class="panel-body">
							<div class="form-group">
								<label>指导教师评语（对优点、缺点进行全面评价，字数不少于300字）</label>
						...
						<div class="panel-footer">
							...
							<c:if test="${finalPaper.syTablePath!=null}">
								<button class="btn btn-primary" type="button" id="tableYuLan" key="0">预览审阅意见表</button>
							</c:if>
						</div>
					</div>
				</form>
	   ...
	   <div class="modal-dialog">
		...
		<input id="tablePath" value="${finalPaper.syTableSrc}" hidden="hidden"/>
