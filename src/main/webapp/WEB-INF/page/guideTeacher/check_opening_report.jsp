	...
	<body>
		<!--下面是代码任务部分-->
			...
			<div class="col-xs-12 col-md-12">
					<form class="form-inline" method="post" action="<%=basePath %>guideTeacher/openingReport.shtm">
			...
			<div class="col-xs-12 col-md-12">
					<form action="<%=basePath %>guideTeacher/openingReport_checkOpeningReport.shtm" method="post">
						<div class="panel panel-primary">
								...
								<table style="text-align:center" class="table table-bordered table-hover">
									...
									<tbody>
										...
										<td><input type="checkbox" name="ids" value="${item.id}"></td>
											...
											<td>
												<a class="btn btn-primary" href="<%=basePath %>downloadFile.chtm?filePath=${item.openingReportPath}">下载</a>&nbsp;&nbsp;
												<a class="btn btn-primary" href="<%=basePath %>openingReportYuLan.shtm?filePathSrc=${item.openingReportSrc}&filePath=${item.openingReportPath}" target="_blank">预览</a>
											</td>								
										</c:forEach>						
									</tbody>
								</table>
							...
							<div class="panel-footer">
								...
								<button type="submit" value="1" name="status" class="btn btn-primary alert-success">通过</button>&nbsp;&nbsp;
								<button type="submit" value="2" name="status" class="btn btn-primary alert-danger">退回</button>&nbsp;&nbsp;
							</div>
