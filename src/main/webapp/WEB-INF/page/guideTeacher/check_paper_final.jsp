	...
	<body style="margin-top:50px;">
		...
		<input type="hidden" value="${successMsg}" id="success">
			...
			<div class="col-xs-12 col-md-12">
					<form class="form-inline" method="post" action="<%=basePath %>guideTeacher/paperFinal.shtm">
		...
		<div class="col-xs-12 col-md-12">
					<form method="post" action="<%=basePath %>guideTeacher/paperFinal_checkPaperFinal.shtm">
						<div class="panel panel-primary">
							<div class="panel-heading">
								<span class="fa fa-check-square-o"></span>&nbsp;&nbsp;审阅论文定稿
							</div>
								...
								<table style="text-align:center" class="table table-bordered table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a class="btn btn-primary" href="<%=basePath %>downloadFile.chtm?filePath=${item.finalPaperPath}">下载</a>&nbsp;&nbsp;
												<a class="btn btn-primary" href="<%=basePath %>finalPaperYuLan.shtm?filePathSrc=${item.finalPaperSrc}&filePath=${item.finalPaperPath}&stuId=${item.student.userId}"  target="_blank">预览</a>
											</td>
										</tr>								
										</c:forEach>							
									</tbody>
