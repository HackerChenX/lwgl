...
<html>
		...
		<script type="text/javascript" src="<%=basePath %>js/page.js"></script>
			<div class="row" style="margin-top: 50px;" id="row1">
				<div class="col-xs-12 col-md-11 col-md-offset-1">
					<form class="form-inline" method="post" action="<%=basePath %>guideTeacher/syGrade.shtm" id="select">
	...
	<div class="col-xs-12 col-md-11 col-md-offset-1">
					<div class="panel panel-primary">
						<div class="panel-heading"><span class="fa fa-check-square-o"></span>&nbsp;&nbsp;录入评阅成绩</div>
							...
							<table style="text-align:center" class="table table-bordered table-hover text-center">
								...
								<tbody>
									...
									<tr>
										...
										<td>${grade.stuName}</td>
										<td>${grade.title}</td>
										<td><input class="input-group form-control" name="pyGrade" value="${grade.pyGrade}"/></td>
										<td>
									...
									<tr>
										<td align="center" colspan="7">暂无需要录入成绩的学生！</td>
									</tr>
								</c:if>
								</tbody>
							</table>
	   ...
	   <div class="modal-dialog">
		...
		<script type="text/javascript">
			$('button[name="luru"]').click(function() {
				...
				var pyGrade = $(this).parent("td").prev("td").children("input[name='pyGrade']").val();
				window.location.href="guideTeacher/pyGrade_setPyGrade.shtm?stuNum="+stuNum+"&pyGrade="+pyGrade;
			});
		</script>
	</body>
