	...
	<body style="margin-top:50px;">
		...
		<input type="hidden" value="${successMsg}" id="success">
			...
			<div class="col-xs-12 col-md-12">
					<form class="form-inline" method="post" action="<%=basePath %>guideTeacher/paperDraft.shtm">
		...
		<div class="col-xs-12 col-md-12">
					<form method="post" action="<%=basePath %>guideTeacher/paperDraft_checkPaperDraft.shtm">
						<div class="panel panel-primary">
							<div class="panel-heading">
								<span class="fa fa-check-square-o"></span>&nbsp;&nbsp;审阅论文初稿
							</div>
