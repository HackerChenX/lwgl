								...
								<table class="table table-bordered table-striped table-hover" style="text-align: center;">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a href="<%=basePath %>majorLeader/selectTB_findStuList.shtm?stageName=task_book&zdTeaStatus=3&className=${submitStatistics.className }">${submitStatistics.notSubmitNum }</a>
											</td>
											<td>
												<a href="<%=basePath %>majorLeader/selectTB_findStuList.shtm?stageName=task_book&zdTeaStatus=0&className=${submitStatistics.className }">${submitStatistics.checkingNum }</a>
											</td>
											<td>
												<a href="<%=basePath %>majorLeader/selectTBo_findStuList.shtm?stageName=task_book&zdTeaStatus=2&className=${submitStatistics.className }">${submitStatistics.checkNotNum }</a>
											</td>
											<td>
												<a href="<%=basePath %>majorLeader/selectTB_findStuList.shtm?stageName=task_book&zdTeaStatus=1&className=${submitStatistics.className }">${submitStatistics.checkPassNum }</a>
											</td>
										</tr>
										</c:forEach>
									</tbody>
