			...
			<div class="row">
				<div class="col-md-9 col-md-offset-1">
					<div class="panel panel-primary">
						...
						<form class="form-horizontal" role="form" method="post" action="<%=basePath %>majorLeader/findTeaTitle_checkTeaTitle.shtm">
							<div style="padding: 50px;">
							<table class="table table-bordered table-responsive table-hover">
								<tbody>
									<tr>
										<td><strong>课题申报人：</strong>${teacherTitle.teacher.teaName}</td>
									</tr>					
									<tr>
										<td><div class="col-sm-10" style="padding:0px;"><strong>课题名称：</strong>${teacherTitle.title}</div>
										<input hidden="hidden" id="titleName" value="${teacherTitle.title}">
										<div class="col-sm-1"><button class="btn btn-success" type="button" onclick="checkTitle()">查重</button>
										</div>
										</td>
									</tr>
									<tr>
										<td><strong>题目性质：</strong>${teacherTitle.nature}</td>
									</tr>
									<tr>
										<td><strong>完成形式：</strong>毕业论文</td>
									</tr>
									<tr>
										<td><strong>立题理由：</strong><br>${teacherTitle.titleReason}</td>
									</tr>
								</tbody>
							</table>
							<div>
								...
								<div>
									<textarea class="form-control" rows="4" name="leaderIdea"></textarea>
								</div>
							</div>
							<div>
							...
							<div style="margin-top: 20px">
								<input type="hidden" value="${teacherTitle.id}" name="ids">
								<button class="btn btn-primary" type="submit">提交</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<a class="btn btn-default" onclick="history.back()">返回</a>						
							</div>
							<div class="alert alert-info" style="margin-top: 20px">
								<p>通过：表示专业负责人认可该课题，上报教学秘书审核发布后，本专业学生可选择作为论文题目。</p>
                                <p>退回修改：表示专业负责人不认可该课题，要求指导教师根据审核意见修改课题内容，重新申报。</p>
							</div>			
							</div>
						</form>				
					</div>
