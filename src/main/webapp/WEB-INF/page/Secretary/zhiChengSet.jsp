	...
	<body>
		...
		<div class="container col-md-8 col-md-offset-2">
			<div class="row" style="margin-top: 50px;margin-left: 0px;margin-right: 0px;">
				<form class="form-inline" method="post" action="<%=basePath %>secretary/findZhiCheng_deleteZhiCheng.shtm">
					<div class="panel panel-primary">
						<div class="panel-heading"><span class="fa fa-check-square-o"></span>&nbsp;&nbsp;教师职称管理</div>
						...
						<div class="table-responsive">
							<table class="table table-bordered table-striped table-hover" style="text-align: center;">
								...
								<tbody>
									<c:forEach var="ZhiCheng" items="${list}">
									<tr>
										<td><input type="checkbox" name="ids" value="${ZhiCheng.id}"></td>
										<td>${ZhiCheng.zhiCheng}</td>
										<td>
											<a href="<%=basePath %>secretary/findZhiCheng_deleteZhiCheng.shtm?ids=${ZhiCheng.id}">删除</a>
										</td>
									</tr>
									</c:forEach>
								</tbody>
						...
						<div class="panel-footer">
							...
							<a class="btn btn-primary" href="<%=basePath %>secretary/findZhiCheng_jumpAddZhiCheng.shtm">添加</a>&nbsp;&nbsp;&nbsp;&nbsp;
