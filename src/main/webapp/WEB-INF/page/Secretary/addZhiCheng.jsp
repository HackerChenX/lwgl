	...
	<body>
		...
		<div class="container col-md-6 col-md-offset-3">
			<div class="row" style="margin-top: 50px;margin-left: 0px;margin-right: 0px;">
				<form class="form-horizontal" method="post" action="<%=basePath %>secretary/findZhiCheng_addZhiCheng.shtm">
					<div class="panel panel-primary">
						<div class="panel-heading"><span class="fa fa-check-square-o"></span>&nbsp;&nbsp;添加职称</div>
						<div class="form-group" style="padding: 10px;">		
								<div class="col-sm-3" style="text-align: right;">
									<label class="control-label">职称名称:</label>
								</div>
								<div class="col-sm-5">
								<input class="form-control" type="text" name="zhiChengName"/>
								</div>			
						</div>				
					<div class="panel-footer ">
						<button class="btn btn-primary " type="submit ">保存</button>&nbsp;&nbsp;
						<a class="btn btn-default " href="<%=basePath %>secretary/findZhiCheng.shtm">返回</a>
