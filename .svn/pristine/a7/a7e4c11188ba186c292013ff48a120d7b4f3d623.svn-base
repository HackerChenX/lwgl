...
<html>
	...
	<body style="font-family: '微软雅黑'; ">
		...
		<div class="row">
			<div class="col-xs-12 col-md-11 col-md-offset-1">
				<div class="panel panel-primary">
					<div class="panel-heading"><span class="fa fa-check-square-o"></span>&nbsp;&nbsp;录入审阅成绩</div>
							...
							<tbody>
								<c:forEach var="grade" items="${page.results}">
									<tr>
										...
										<td>${grade.stuName}</td>
										<td>${grade.title}</td>
										<td><input class="input-group form-control" name="syGrade" value="" placeholder="${grade.syGrade}" /></td>
										<td>
	   ...
	   <div class="modal-dialog">
		...
		<script type="text/javascript">
			$('button[name="luru"]').click(function() {
				...
				var syGrade = $(this).parent("td").prev("td").children("input[name='syGrade']").val();
				window.location.href = "guideTeacher/syGrade_setSyGrade.shtm?stuNum=" + stuNum + "&syGrade=" + syGrade;
			});
		</script>
	</body>  
