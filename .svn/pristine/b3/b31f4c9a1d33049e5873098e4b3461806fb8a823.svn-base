...
<html>
	...
	<body>
		...
		<div class="col-xs-12 col-md-12">
			<div class="panel panel-primary">
				<div class="panel-body">
					<form role="form" class="form-inline" method="post" action="<%=basePath %>secretary/findAllGrade.shtm" id="select">
		...
		<div class="row">
			<div class="col-xs-12 col-md-12">
				<form role="form" action="<%=basePath %>secretary/exportAllGrade.shtm" method="post">
					<div class="panel panel-primary">
							...
							<table class="table table-bordered table-striped table-hover" style="text-align: center;">
								...
								<tbody>
									...
									<tr>
										...
										<td>${grade.zdZhiCheng}</td>
										<td>${grade.pyTeacherName }</td>
										<td>${grade.pyZhiCheng}</td>
									</tr>
									</c:forEach>
								</tbody>
							</table>
